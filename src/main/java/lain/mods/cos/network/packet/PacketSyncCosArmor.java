...
public class PacketSyncCosArmor extends NetworkPacket {
    ...
    public PacketSyncCosArmor(EntityPlayer player, int slot) {
        ...
        this.slot = slot;
        this.isSkinArmor = CosmeticArmorReworked.invMan.getCosArmorInventory(this.uuid)
            .isSkinArmor(slot);
        this.itemCosArmor = CosmeticArmorReworked.invMan.getCosArmorInventory(this.uuid)
            .getStackInSlot(slot);
    }
